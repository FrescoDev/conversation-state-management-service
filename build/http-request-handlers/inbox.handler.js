...
var _conversationStateManagementService = require('../../conversation-state-management-service');

var _conversationStateManagementService2 = _interopRequireDefault(_conversationStateManagementService);
...
var InboxHandler = function (_BaseHandler) {
  ...
  (0, _createClass3.default)(InboxHandler, [{
    ...
    value: function index(req, res) {
      var worker = new _conversationStateManagementService2.default();
